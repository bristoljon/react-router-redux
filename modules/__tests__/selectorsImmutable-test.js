import { getLocation, createMatchSelector } from '../selectorsImmutable'
import { createStore } from 'redux'
import { combineReducers } from 'redux-immutable'
import { fromJS } from 'immutable'

import { routerReducer, LOCATION_CHANGE } from '../reducerImmutable'
...
describe('selectors', () => {
  ...
  describe('getLocation', () => {
    it('gets the location from the state', () => {
      ...
      expect(getLocation(state)).toEqual(fromJS(location))
    })
  })
