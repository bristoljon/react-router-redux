(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('react-router'), require('immutable')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'react-router', 'immutable'], factory) :
	(factory((global.ReactRouterRedux = {}),global.React,global.PropTypes,global.ReactRouter,global.Immutable));
}(this, (function (exports,React,PropTypes,reactRouter,immutable) { 'use strict';
...
var getLocation$1 = function getLocation(state) {
  return state.getIn(['router', 'location']);
};

var createMatchSelector$1 = function createMatchSelector(path) {
  var lastPathname = null;
  var lastMatch = null;
  return function (state) {
    var pathname = getLocation$1(state).get('pathname');
    if (pathname === lastPathname) {
      return lastMatch;
    }
    lastPathname = pathname;
 ...
 * receives a location change.
 */
var LOCATION_CHANGE$1 = '@@router/LOCATION_CHANGE';
...
exports.getLocationImmutable = getLocation$1;
exports.createMatchSelectorImmutable = createMatchSelector$1;
exports.routerReducerImmutable = routerReducer$1;
